...
queue_t* create_queue(unsigned int _capacity){
	...
	int arraySize = (sizeof(int))*_capacity;
	myQueue->data = (int*)malloc(arraySize);
...
int queue_enqueue(queue_t* q, int item){
	...
	//q back is at an empty spot, we insert data there
	finalPos = q->back;
	q->data[finalPos] = item;
	//then we shift back one space.
