...
void sortIntegers(int* array, unsigned int size){
  ...
  int* temporal = (int*)malloc(sizeof(int)*size);

  int* inputArray = (int*)malloc(sizeof(int)*size);

  

  int i;

  // copy given array into a allocated array
  ...
  mergeSort(inputArray, temporal, 0, size - 1);


  // copy inputArray into intial array
